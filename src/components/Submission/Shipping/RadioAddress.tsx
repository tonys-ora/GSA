import { Card, CardActionArea, CardContent, Radio, Stack, Typography } from '@mui/material'

import { dispatch, updateShippingAddress } from '@/store'
import { AddressType } from '@/types/Submission'

const RadioAddress = ({ address, detail, phone, checked }: AddressType) => {
  return (
    <Card>
      <CardActionArea
