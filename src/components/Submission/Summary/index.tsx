...
export default function index() {
  ...
  const data = useMemo(
    () => [
      ...
      {
        title: 'Grading fee',
        value: '$' + summary.gradingFee
      },
      {
        title: 'Insured Return Shipping',
              ...
              val[1] !== null ? (
                <Stack key={val[0]} direction='row' justifyContent='space-between'>
                  <Typography variant='subtitle2' color='grey'>
                    {SummaryConst[val[0] as keyof typeof SummaryConst].title}
                  </Typography>
                  <Typography variant='subtitle2'>
                    {SummaryConst[val[0] as keyof typeof SummaryConst].prefix + val[1]}
                  </Typography>
                </Stack>
              ) : null
            )}
