...
import {Button, Divider, Paper, Stack, IconButton, Typography } from '@mui/material'
    ...
    <Paper variant='outlined' sx={{padding: '24px', width:'400px', borderRadius: '16px'}}>
      <Stack gap={'16px'}>
        ...
        {[
          ...
          item.title === 'divider' ? <Divider/>
          :<Stack direction='row' justifyContent='space-between'>
            <Typography variant='subtitle2' color='grey'>{item.title}</Typography>
